    ...
    public void onViewCreated( View view, Bundle savedInstanceState) {
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(){
            ...
            public void onGlobalLayout(){
                ...
                if(playerResourceId == R.drawable.nave64x64smooth) {
                    theGameEngine.addGameObject(new SpaceShipPlayer(theGameEngine, playerResourceId,R.drawable.proyectiljugador64x64smooth,1,1,300,4,2));
                }else{
                    theGameEngine.addGameObject(new SpaceShipPlayer(theGameEngine, playerResourceId,R.drawable.proyectiljugador264x64smooth,3,3,700,2,3));
                }
